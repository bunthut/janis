...
const readmeBody = (
 ...
 Quick tips for the Janis Plugin:
  ...
  - Templates now support built in variables 🎉 and more. For full documentation and features, see the [README](https://github.com/joplin/janis#readme).`);
